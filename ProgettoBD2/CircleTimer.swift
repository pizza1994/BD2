...
//  ProgettoBD2
//
//  Created by Luca Pitzalis on 02/07/17.
...
class CircleTimer: UIView {
    ...
    override init(frame: CGRect) {
        ...
        circleLayer.strokeColor = UIColor(red: CGFloat(242.0/255.0), green: CGFloat(229.0/255.0), blue:CGFloat(50.0/255.0), alpha: 1.0).cgColor
